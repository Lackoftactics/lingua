  ...
  describe "#sentences" do
    describe "multi-paragraph text" do
      ...
      it "should get the correct number of sentences" do
        expect(@sentences.count).to eq(5)
      end
    ...
    describe "quoted sentences" do
      ...
      it "should get the correct sentences" do
        expect(@sentences[0]).to eq("As Milton Bradley once said, \"board games are the shit.\"")
        expect(@sentences[1]).to eq("And I'm inclined to agree.")
        expect(@sentences[2]).to eq("\"Why can't we be friends?\"")
      end
    end
    ...
    describe "ellipses correction" do
      ...
      it "should get the right sentences" do
        expect(@sentences[0]).to eq("Well... why would you do that?")
        expect(@sentences[1]).to eq("Let's not fight.")
      end
    end
    ...
    describe "short sentences w/ line breaks" do
      ...
      it "should stop at line breaks" do
        expect(@sentences[1]).to eq("Let's see -")
      end
    end
